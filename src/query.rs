...
use crate::condition::{complex_condition::ComplexCondition, Condition};
...
pub struct Query {
    ...
    pub where_condition: Option<ComplexCondition>,  // DELETE (always), SELECT (sometimes), UPDATE (always) .
